...
<section class="body-font">
  <div class="conauto flex bg-indigo-900 md:px-16 px-3 py-10 md:flex-row flex-col-reverse items-center" id="temp">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-5xl text-3xl my-4 font-extrabold text-white">Feroze Gandhi Polytechnic, Raebareli</h1>
