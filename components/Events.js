...
const Events = () => {
  return (
    <section class="body-font">
      <div
        class="conauto flex bg-orange-800 px-1 md:px-16 py-1 md:flex-row flex-col justify-center items-center"
        id="temp"
      >
       ...
       <img src="/im4.jpeg"/>
        ...
        <div class="lg:w-1/2 lg:w-full md:w-1/2 w-full">
          <div className="bg-white p-3 m-6 rounded-lg  md:block hidden">
            <h4 class="title-font sm:text-4xl text-2xl  font-extrabold text-center ">
              Facilities
            </h4>
        ...
        <div class="lg:1/2 lg:w-full md:w-1/2 w-full">
          <div className="bg-white p-3 m-6 rounded-lg">
            <h4 class="title-font sm:text-4xl text-2xl md:mb-4 mb-2 font-extrabold text-center ">
              Photo Gallery
            </h4>
            <Carousel
            ...
            >
              <img
                src="/gallery/zb121.jpg"
                alt="image 1"
                className="h-full w-full object-cover"
              />
              <img
                src="/gallery/zb56.jpg"
                alt="image 1"
                className="h-full w-full object-cover"
              />
              <img
