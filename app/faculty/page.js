...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-12 mx-auto">
    ...
    <FacultyCard name="P.C. Katiyar (HOD)" post="Mechanical Engineering" imgLink="/staff_images/591.jpg"/>

    <FacultyCard name="Ravindera Solanki" post="Lecturer, Mechanical Engineering" imgLink="/staff_images/8816.jpg"/>

    <FacultyCard name="S.K. Kannaujia (HOD)" post="CS & Engg, IT & PGDCA" imgLink="/staff_images/625.jpg"/>
    
    <FacultyCard name="Avneesh Verma" post="Lecturer, Mechanical Engineering & Hostel Warden" imgLink="/staff_images/715.jpg"/>

    <FacultyCard name="Renu Gautam (HOD)" post="Instrumentation & Control" imgLink="/staff_images/69.jpg"/>
    
    <FacultyCard name="Chandra Shekhar Saroj (HOD)" post="MOM & SP" imgLink="/staff_images/10.jpg"/>
    
    <FacultyCard name="Dr. Nisheeth Upadhyay (HOD)" post="Electronics Engg." imgLink="/staff_images/972.jpg"/>

    <FacultyCard name="Shweta Verma" post="Lecturer, Electronics Engg." imgLink="/staff_images/00.jpg"/>

    <FacultyCard name="Dr. Anjali Trivedi" post="Lecturer, Chemistry" imgLink="/staff_images/68.jpg"/>

    <FacultyCard name="Saumya Mishra" post="Lecturer, Electrical Engg." imgLink="/staff_images/91.jpg"/>

    <FacultyCard name="Ashish Kumar" post="Lecturer, Mechanical Engg." imgLink="/staff_images/95.jpg"/>
    ...
    <FacultyCard name="Ratnesh Sonkar" post="Workshop Superitendant, NCC (Lieutenant)" imgLink="/staff_images/926.jpg"/>

    <FacultyCard name="Ram Chandra Verma" post="Workshop Instructor" imgLink="/staff_images/11.jpg"/>
    
    <FacultyCard name="Ganesh Mishra" post="Lecturer, Electronics Engg." imgLink="/staff_images/53.jpg"/>
    ...
    <FacultyCard name="Anoop Shukla" post="Lecturer, Electronics Engg." imgLink="/staff_images/716.jpg"/>
    ...
    <FacultyCard name="Suresh Kumar" post="Clerk" imgLink="/staff_images/0918.jpeg"/>
    <FacultyCard name="Abbas Zafri" post="T&P Assistant" imgLink="/staff_images/00.jpg"/>
    <FacultyCard name="Suresh Kumar" post=" " imgLink="/staff_images/00.jpg"/>
